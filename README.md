...
<img width="865" alt="image" src="https://github.com/user-attachments/assets/f396aca1-b014-4004-8eb2-02aa7ebbccb4" />
...
# make sure the expressionMatrixis normalized before input. Otherwise, you will need to adjust the *smooth.ceiling* parameter appropriately to account for the unprocessed count values. 
